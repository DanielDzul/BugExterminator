...
namespace BugExterminator.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        {
            var ticketAttachments = db.TicketAttachment.Include(t => t.Ticket);
        ...
        public ActionResult Create([Bind(Include = "Id,AuthorId,Created,Description,TicketId,UserId,FilePath")] TicketAttachment ticketAttachment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,AuthorId,Created,Description,TicketId,UserId,FilePath")] TicketAttachment ticketAttachment)
        {
            if (ModelState.IsValid)
            {
